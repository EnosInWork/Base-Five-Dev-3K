...
Config.Strings = {
	ExitVehicle = "Quittez le véhicule pour faire le plein",
	EToRefuel = "Appuyer sur ~g~E ~w~pour faire le plein du véhicule",
	JerryCanEmpty = "Bidon d'essence vide",
	FullTank = "Réservoir d'essence rempli",
	PurchaseJerryCan = "Appuyer sur ~g~E ~w~pour acheter un bidon d'essence pour ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyer sur ~g~E ~w~pour arreter de faire le plein",
	CancelFuelingJerryCan = "Appuyer sur ~g~E ~w~pour arreter de faire le plein",
	NotEnoughCash = "Pas assez d'argent",
	RefillJerryCan = "Appuyer sur ~g~E ~w~ pour remplir le bidon d'essence pour ",
	NotEnoughCashJerryCan = "Pas assez d'argent",
	JerryCanFull = "Bidon d'essence rempli",
	TotalCost = "$",
}
