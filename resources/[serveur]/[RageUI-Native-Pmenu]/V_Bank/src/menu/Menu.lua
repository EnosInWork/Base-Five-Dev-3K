...
---@return table
---@public
function ValUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = ValUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 30
    Menu.Parent = nil
    Menu.WidthOffset = 100
    Menu.Open = false
    Menu.Controls = ValUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + ValUI.Settings.Items.Subtitle.Text.X, Menu.Y + ValUI.Settings.Items.Subtitle.Text.Y, 0, ValUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, ValUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, ValUI.Menus)
end
...
---@return table
---@public
function ValUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function ValUI.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function ValUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function ValUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + ValUI.Settings.Items.Subtitle.Text.X, self.Y + ValUI.Settings.Items.Subtitle.Text.Y, 0, ValUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, ValUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function ValUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function ValUI.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function ValUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function ValUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function ValUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function ValUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function ValUI.Menus:Closable(boolean)
...
function ValUI.Menus:AddInstructionButton(button)
...
function ValUI.Menus:RemoveInstructionButton(button)
...
function ValUI.Menus:UpdateInstructionalButtons(Visible)
