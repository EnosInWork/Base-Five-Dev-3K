...
RegisterNetEvent("ValUI:Popup")
AddEventHandler("ValUI:Popup", function(array)
    ValUI.Popup(array)
end)
...
---@param array table
---@public
function ValUI.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
