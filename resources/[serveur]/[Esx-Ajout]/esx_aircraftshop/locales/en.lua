Locales['en'] = {
  ...
  ['aircraft_dealer']         = 'Vendeur de véhicule Aérien',
  ...
  ['sell_menu']               = 'Appuie sur ~INPUT_CONTEXT~ to sell your ~y~%s~s~ for ~g~$%s~s~',
  ...
  ['shop_menu']               = 'Appuie sur ~INPUT_CONTEXT~ pour ouvrir le menu',
  ['vehicle_dealer']          = 'vehicle - Car Dealer',
  ['vehicle_menu']            = 'Appuie sur ~INPUT_CONTEXT~ to give back the rented vehicle',
