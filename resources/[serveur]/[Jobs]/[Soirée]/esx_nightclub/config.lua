...
-------- SHOPS --------
    ...
    Flacons = {
        Pos   = { x = -1584.29, y = -3015.57, z = -76.97 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        Color = { r = 238, g = 0, b = 0 },
        Type  = 23,
        Items = {
            ...
            { name = 'rhum',       label = _U('rhum'),    price = 25 },
            { name = 'whisky',     label = _U('whisky'),  price = 35 },
    ...
    NoAlcool = {
        Pos   = { x = -1578.02, y = -3016.66, z = -79.991 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        Color = { r = 238, g = 110, b = 0 },
        Type  = 23,
        Items = {
            { name = 'soda',        label = _U('soda'),     price = 5 },
    ...
    Apero = {
        ...
        Type  = 23,
        Items = {
            { name = 'bolcacahuetes',   label = _U('bolcacahuetes'),    price = 12 },
            ...
            { name = 'saucisson',       label = _U('saucisson'),        price = 40 },
            { name = 'grapperaisin',    label = _U('grapperaisin'),     price = 25 }
        },
    },
