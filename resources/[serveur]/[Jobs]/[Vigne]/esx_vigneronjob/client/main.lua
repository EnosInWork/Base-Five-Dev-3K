...
function OpenVehicleSpawnerMenu()
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		local elements = {
			{label = 'Voiture Patron',  value = '208gti'},
			{label = 'V�hicule de Travail',  value = 'guardian'},
		}
...
function blips()
	if publicBlip == false then
		...
		AddTextComponentString("Gold Luxury")
