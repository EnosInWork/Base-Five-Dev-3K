		...
		elseif data.current.value == 'object_spawner' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_mechanic_actions_spawn', {
				...
				elements = {
					...
					{label = _U('roadcone1'), value = 'prop_roadcone01a'},
					{label = _U('roadcone2'), value = 'prop_roadcone01c'},
					{label = _U('roadcone3'), value = 'prop_roadcone02b'},
					{label = _U('trolley'), value = 'prop_cs_trolley_01'},
					{label = _U('gcchair'), value = 'v_ret_gc_chair02'},
				...
				if model == 'prop_roadcone02a' then
					z = z - 2.0
				elseif model == 'prop_roadcone01a' then
					z = z - 2.0
				end
				
				if model == 'prop_roadcone01c' then
					z = z - 2.0
				elseif model == 'prop_roadcone02b' then
					z = z - 2.0	
				end

				if model == 'prop_cs_trolley_01' then
					z = z - 2.0
				elseif model == 'v_ret_gc_chair02' then
					z = z - 2.0	
				end

				if model == 'prop_toolchest_01' then
					z = z - 2.0	
				end
