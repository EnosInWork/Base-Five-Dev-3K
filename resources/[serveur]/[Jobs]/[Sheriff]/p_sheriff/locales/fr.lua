Locales['fr'] = {
	...
	--Misc
		...
		['map_blip'] = 'Commissariat L.S County Sheriff',
	--Notifications
		['from'] = '~s~ à ~b~',
	...
	--Custom Vehicles
	['impound_prompt'] = 'Déplacement du véhicule vers la fourrière',
	['impound_successful'] = 'Véhicule placé en fourrière avec succès',
}
