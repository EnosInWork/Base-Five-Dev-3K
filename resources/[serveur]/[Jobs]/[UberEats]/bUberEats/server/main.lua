...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'ubereats', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'ubereats', _U('ubereats_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'ubereats', 'ubereats', 'society_ubereats', 'society_ubereats', 'society_ubereats', {type = 'private'})
...
RegisterServerEvent('esx_ubereatsjob:startHarvest')
AddEventHandler('esx_ubereatsjob:startHarvest', function(zone)
...
RegisterServerEvent('esx_ubereatsjob:stopHarvest')
AddEventHandler('esx_ubereatsjob:stopHarvest', function()
  local _source = source
...
RegisterServerEvent('esx_ubereatsjob:startTransform')
AddEventHandler('esx_ubereatsjob:startTransform', function(zone)
  local _source = source
...
RegisterServerEvent('esx_ubereatsjob:stopTransform')
AddEventHandler('esx_ubereatsjob:stopTransform', function()
  local _source = source
      ...
      if xPlayer.getInventoryItem('sachetketchup').count <= 0 then
        ...
        if (ketchup == 1) then
          SetTimeout(1100, function()
            ...
            TriggerEvent('esx_addonaccount:getSharedAccount', 'society_ubereats', function(account)
...
RegisterServerEvent('esx_ubereatsjob:startSell')
AddEventHandler('esx_ubereatsjob:startSell', function(zone)
  local _source = source
...
RegisterServerEvent('esx_ubereatsjob:stopSell')
AddEventHandler('esx_ubereatsjob:stopSell', function()
  local _source = source
...
RegisterServerEvent('esx_ubereatsjob:getStockItem')
AddEventHandler('esx_ubereatsjob:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_ubereats', function(inventory)
...
ESX.RegisterServerCallback('esx_ubereatsjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_ubereatsjob:putStockItems')
AddEventHandler('esx_ubereatsjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_ubereatsjob:getFridgeStockItem')
AddEventHandler('esx_ubereatsjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_ubereats_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_ubereatsjob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_ubereatsjob:putFridgeStockItems')
AddEventHandler('esx_ubereatsjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_ubereatsjob:buyItem')
AddEventHandler('esx_ubereatsjob:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_ubereatsjob:ingredientgBurger')
AddEventHandler('esx_ubereatsjob:ingredientgBurger', function(itemValue)
...
RegisterServerEvent('esx_ubereatsjob:craftingBurger')
AddEventHandler('esx_ubereatsjob:craftingBurger', function(itemValue)
...
ESX.RegisterServerCallback('esx_ubereatsjob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_ubereats', function(store)
...
ESX.RegisterServerCallback('esx_ubereatsjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_ubereatsjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_ubereatsjob:getPlayerInventory', function(source, cb)
