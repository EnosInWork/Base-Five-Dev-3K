...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'ubereats' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function setUniform(job, playerPed)
  TriggerEvent('skinchanger:getSkin', function(skin)
    ...
    if skin.sex == 0 then
      ...
      if job ~= 'citizen_wear' and job ~= 'ubereats_outfit' then
...
function OpenCloakroomMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'ubereats_outfit' then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'ubereats', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'ubereats_actions',
    {
      title    = _U('ubereats'),
      align    = 'top-left',
      elements = elements
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('esx_ubereatsjob:craftingBurger', data2.current.value)
       ...
       if data.current.value == 'menu_ingredient' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu3)
                ...
                TriggerServerEvent('esx_ubereatsjob:ingredientgBurger', data2.current.value)
                animsAction({ lib = "mini@drinking", anim = "shots_barman_b" })
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_ubereats', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_ubereatsj:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_ubereatsjob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_ubereatsjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_ubereatsjob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_ubereatsjob:getFridgeStockItems', function(items)
    ...
    ESX.UI.Menu.Open(
      ...
      {
        title    = _U('ubereats_fridge_stock'),
        elements = elements
      },
      function(data, menu)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_ubereatsjob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_ubereatsjob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_ubereatsjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_ubereatsjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_ubereatsjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'ubereats_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
            TriggerServerEvent('esx_ubereatsjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_ubereatsjob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_ubereatsjob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_ubereatsjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_ubereatsjob:hasExitedMarker', LastZone)
            end
...
AddEventHandler('esx_ubereatsjob:hasExitedMarker', function(zone)
  ESX.UI.Menu.CloseAll()
  if (zone == 'KetchupFarm') and PlayerData.job ~= nil and PlayerData.job.name == 'ubereats' then
    TriggerServerEvent('esx_ubereatsjob:stopHarvest')
  end  
  if (zone == 'SachetKetchup') and PlayerData.job ~= nil and PlayerData.job.name == 'ubereats' then
    TriggerServerEvent('esx_ubereatsjob:stopTransform')
  end
  if (zone == 'SellFarm') and PlayerData.job ~= nil and PlayerData.job.name == 'ubereats' then
    TriggerServerEvent('esx_ubereatsjob:stopSell')
  end
  CurrentAction = nil
end)
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'ketchup_harvest' then
          TriggerServerEvent('esx_ubereatsjob:startHarvest', CurrentActionData.zone)
        end
        if CurrentAction == 'ketchup_sachet' then
          TriggerServerEvent('esx_ubereatsjob:startTransform', CurrentActionData.zone)
        end
        if CurrentAction == 'farm_resell' then
          TriggerServerEvent('esx_ubereatsjob:startSell', CurrentActionData.zone)
        end
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'ubereats', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'ubereats')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'ubereats', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'ubereats_actions') then
